...
whatis("Installed on 05/13/2024")
...
-- bash sets shell functions and aliases
  cmd = "unalias spacktivate; " ..
        ...
        "unset -f _spack_audit_externals;" ..
  ...
  cmd1= "unset -f _spack_edit;" ..
        ...
        "unset -f _spack_env_mv;" ..
        "unset -f _spack_env_rename;" ..
        ...
        "unset -f _spack_buildcache_push;" ..
        "unset -f _spack_buildcache_rebuild_index;" ..
        "unset -f _spack_pkg_grep;" ..
        "unset -f _unit_tests;" ..
        "unset -f SPACK_TESTS;" ..
        "unset SPACK_PYTHON;" ..
